...
const SideMenu = ({ page, theme, visible, handleClick }) => {
	...
	return (
		<Sidebar as={Menu} vertical width="thin" animation="uncover" visible={visible} inverted={theme}>
			...
			<Menu.Item name="dashboard" active={page === "dashboard"} onClick={handleClick} as={Link} to="/" />
			<Menu.Item name="notice board" active={page === "notice board"} onClick={handleClick} as={Link} to="/notice" />
			<Menu.Item>
				<Menu.Header content="Attendence" />
				<Menu.Menu>
					<Menu.Item name="day" active={page === "day"} onClick={handleClick} as={Link} to="/attendence" />
					<Menu.Item name="month" active={page === "month"} onClick={handleClick} as={Link} to="/attendencemonth" />
				</Menu.Menu>
			</Menu.Item>
			<Menu.Item>
			...
			<Menu.Item>
				...
				<Menu.Menu>
					...
					<Menu.Item name="update student" active={page === "update student"} onClick={handleClick} as={Link} to="/updatestudent" />
				</Menu.Menu>
			</Menu.Item>
			<Menu.Item>
				...
				<Menu.Menu>
					...
					<Menu.Item name="update teacher" active={page === "update teacher"} onClick={handleClick} as={Link} to="/updateteacher" />
				</Menu.Menu>
			</Menu.Item>
			<Menu.Item>
