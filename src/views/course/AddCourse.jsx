...
const AddCourse = props => {
	...
	return (
		<Segment className={loading ? `loading` : ``}>
			...
			>
				<Form.Input required pattern="[\w\s',\-]+" name="name" label="Course name" placeholder="Full name of the Course" onChange={onChange} />
				<Form.Group>
					<Form.Input required pattern="[\w\.\s]+" name="identifier" label="Course Abbreviation" placeholder="e.g. BCA" onChange={onChange} />
					<Form.Select
						search
						required
						wrapSelection
