...
const About = ({ data, history, access, theme }) => {
	document.title = getName(data.name) + ` | About`
					...
					<Table.Body>
						...
						<Table.Row>
							...
							<Table.Cell
								selectable
								content={
									<a href={`tel:` + data.father.contactNumber}>{data.father.contactNumber}</a>
								}
							/>
						</Table.Row>
						<Table.Row>
						...
						<Table.Row>
							...
							<Table.Cell
								selectable
								content={
									<a href={`tel:` + data.mother.contactNumber}>{data.mother.contactNumber}</a>
								}
							/>
						</Table.Row>
						<Table.Row>
